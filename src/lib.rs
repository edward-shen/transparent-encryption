...
//! [`cipher`].
//!
//! Additionally, [`Reader`] and [`AsyncWriter`] implement [`AsyncRead`] and
...
/// Convenience alias for an async writer with a reasonable buffer.
#[cfg(feature = "tokio")]
pub type AsyncBufWriter<Inner, Cipher> = writer::AsyncWriter<Inner, Cipher, 4096>;
